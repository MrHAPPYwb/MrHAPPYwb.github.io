...
export function createGemMaterial(color: number, rough = false) {
  return new THREE.MeshPhysicalMaterial({
    color,
    emissive: new THREE.Color(color).multiplyScalar(0.075),
    emissiveIntensity: 1.15,
    metalness: 0,
    roughness: rough ? 0.12 : 0.012,
    transmission: rough ? 0.42 : 0.76,
    thickness: rough ? 1.1 : 1.55,
    ior: 2.417,
    dispersion: rough ? 0.06 : 0.18,
    iridescence: rough ? 0.08 : 0.2,
    iridescenceIOR: 1.3,
    attenuationColor: new THREE.Color(color).lerp(new THREE.Color(0xffffff), 0.45),
    attenuationDistance: 1.2,
    specularIntensity: 1,
    specularColor: 0xffffff,
    envMapIntensity: rough ? 2.4 : 4,
    transparent: false,
    opacity: 1,
